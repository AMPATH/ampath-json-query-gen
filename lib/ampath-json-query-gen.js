(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("ampath-json-query-gen", [], factory);
	else if(typeof exports === 'object')
		exports["ampath-json-query-gen"] = factory();
	else
		root["ampath-json-query-gen"] = factory();
...
exports.BasePatientListGen = undefined;

var _basePatientlistGen = __webpack_require__(1);

var _basePatientlistGen2 = _interopRequireDefault(_basePatientlistGen);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// import Json2Sql from './json2Sql.js';
exports.BasePatientListGen = _basePatientlistGen2.default;
...
var _ampathJson2sql = __webpack_require__(2);
...
var BasePatientListGen = function () {
  function BasePatientListGen(baseSchema, aggregateSchema, patientListTemplateSchema, params) {
    _classCallCheck(this, BasePatientListGen);

    this.baseSchema = null;
    this.aggregateSchema = null;
    this.patientListTemplateSchema = null;
    this.params = null;
  ...
  _createClass(BasePatientListGen, [{
    key: 'generatePatientListSchema',
    value: function generatePatientListSchema() {
      var generatedValues = {};
    ...
    key: 'addMappedParamsToParamsObject',
    value: function addMappedParamsToParamsObject(datasources, params) {
      return _ampathJson2sql.SqlGenerators.mapParamsMultipleDataSources(datasources, params);
    }
  }, {
    key: 'addMissingColumns',
    value: function addMissingColumns(destinationSchema, sourceSchema) {
      var _this = this;

      sourceSchema.columns.forEach(function (column) {
        if (!_this.columnExistsInColumnArray(column, destinationSchema.columns)) {
          destinationSchema.columns.push(column);
        }
      });
    }
  }, {
    key: 'addSourcesToGeneratedSchema',
    value: function addSourcesToGeneratedSchema(aggregateSchema, baseSchema, templateSchema) {
      var genDirective = aggregateSchema.dynamicJsonQueryGenerationDirectives.patientListGenerator.generatingDirectives;

      this.modifyDynamicPLMainSourceObject(genDirective.joinDirectives, baseSchema.sources[0], templateSchema.sources[0]);

      templateSchema.sources.forEach(function (source) {
        baseSchema.sources.push(source);
      });
    }
  }, {
    key: 'addMissingFilters',
    value: function addMissingFilters(aggregateSchema, baseSchema, suppliedParams) {
      var _this2 = this;

      if (aggregateSchema.dynamicJsonQueryGenerationDirectives && aggregateSchema.dynamicJsonQueryGenerationDirectives.patientListGenerator && aggregateSchema.dynamicJsonQueryGenerationDirectives.patientListGenerator.skipParams) {
        var skipParams = aggregateSchema.dynamicJsonQueryGenerationDirectives.patientListGenerator.skipParams;
        var paramsCopy = Object.assign({}, suppliedParams);

        skipParams.forEach(function (e) {
          return delete paramsCopy[e];
        });
        suppliedParams = paramsCopy;
      }
      baseSchema.columns.forEach(function (column) {
        if (suppliedParams[column.alias] !== undefined) {
          var filter = _this2.getFilterObject(column, suppliedParams[column.alias]);
    ...
    key: 'addPagingParams',
    value: function addPagingParams(baseSchema) {
    ...
    key: 'addGroupByParams',
    value: function addGroupByParams(baseSchema, templateSchema) {
    ...
    key: 'columnExistsInColumnArray',
    value: function columnExistsInColumnArray(column, columnArray) {
    ...
    key: 'willColumnTitlesCollide',
    value: function willColumnTitlesCollide(columnA, columnB) {
    ...
    key: 'modifyDynamicPLMainSourceObject',
    value: function modifyDynamicPLMainSourceObject(joinDirective, baseTableSource, templateTableSource) {
      ...
      var baseColumn = baseTableSource.alias + '.' + joinDirective.baseColumn;
      var templateColumn = templateTableSource.alias + '.' + joinDirective.templateColumn;

      templateTableSource.join.joinCondition = templateTableSource.join.joinCondition.replace('<<base_column>>', baseColumn);

      templateTableSource.join.joinCondition = templateTableSource.join.joinCondition.replace('<<template_column>>', templateColumn);
    }
  }, {
    key: 'getFilterObject',
    value: function getFilterObject(columnObject, param) {
    ...
    key: 'getSimpleColumnFilterObject',
    value: function getSimpleColumnFilterObject(columnObject, param) {
      var expression = (columnObject.column || columnObject.alias) + ' = ';
    ...
    key: 'getSimpleExpressionColumnFilterObject',
    value: function getSimpleExpressionColumnFilterObject(columnObject, param) {
      var expression = '';
    ...
    key: 'getCaseExpressionColumnFilterObject',
    value: function getCaseExpressionColumnFilterObject(columnObject, param) {
      var expression = '';
      ...
      columnObject.expressionOptions.caseOptions.forEach(function (option) {
  ...
  return BasePatientListGen;
}();

exports.default = BasePatientListGen;
...
//# sourceMappingURL=ampath-json-query-gen.js.map